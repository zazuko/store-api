...
export class Stardog extends Store {
  ...
  async createDb (dbname, options = {}) {
    Object.assign({ databaseOptions: {}, options: {}, params: {} }, options)
  ...
  async query (dbname, sparql, options = {}) {
    Object.assign({ accept: 'application/json', params: {}, additionalHandlers: {} }, options)
